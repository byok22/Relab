...
{
    public class GetAllTestsByStatusUseCase
    {
        ...
        public GetAllTestsByStatusUseCase( 
            IMapper mapper, 
        ...
        public   async Task<List<TestDto>> Execute(TestStatusEnum testStatusEnum){    

            var allTest = await _testRepository.GetAllByStatusAsync(testStatusEnum);
